...
export default function DashboardPage() {
    return (
        ...
        <div className="space-y-2">
            <h1 className="text-3xl font-bold tracking-tight text-balance">Panel de Control - Hospired</h1>
            <p className="text-muted-foreground text-pretty">
            Bienvenido al sistema de gestión hospitalaria. Aquí tienes un resumen de las actividades del día.
            </p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <CardContent>
                ...
                <p className="text-xs text-muted-foreground">75% de las citas programadas</p>
            </CardContent>
            </Card>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            ...
            <CardHeader>
                ...
                <CardDescription>Últimas actividades del sistema hospitalario</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
                ...
                <div className="flex-1 space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">María González - Consulta General - 14:30</p>
                </div>
                ...
                <div className="flex-1 space-y-1">
                    <p className="text-sm font-medium leading-none">Nuevo paciente registrado</p>
                    <p className="text-sm text-muted-foreground">Carlos Mendoza - Expediente #P-2024-0156</p>
                </div>
                ...
                <div className="flex-1 space-y-1">
                    <p className="text-sm font-medium leading-none">Consulta completada</p>
                    <p className="text-sm text-muted-foreground">Dr. Ramírez - Paciente: Ana López</p>
                </div>
            ...
            <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between rounded-lg border p-3">
                    ...
                    <p className="text-xs text-muted-foreground">Consultorio 1</p>
                    </div>
                </div>
                ...
                <div className="flex items-center justify-between rounded-lg border p-3">
                    ...
                    <p className="text-xs text-muted-foreground">Consultorio 2</p>
                    </div>
                </div>
