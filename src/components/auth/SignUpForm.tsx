    ...
    <div className="mx-auto mt-8 max-w-md">
      {confirmationEmailSent ? (
        <div className="space-y-4 text-center">
          <Alert>
            Hemos enviado un correo a {submittedEmail}. Revisa tu bandeja de entrada para confirmar tu cuenta.
          </Alert>
          <RouterLink href="/auth/sign-in" className="text-sm text-blue-600 hover:underline">
            Ir a inicio
          </RouterLink>
        </div>
      ) : (
